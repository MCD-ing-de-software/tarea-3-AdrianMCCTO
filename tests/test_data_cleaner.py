...
class TestDataCleaner(unittest.TestCase):
    ...
    def test_drop_invalid_rows_raises_keyerror_for_unknown_column(self):
        ...
        # Verificar que una columna inexistente lanza KeyError
    ...
    def test_trim_strings_strips_whitespace_without_changing_other_columns(self):
        ...
        """
        # Crear un DataFrame sin None en la columna name para que sea string dtype
        df = pd.DataFrame({
    ...
    def test_trim_strings_raises_typeerror_for_non_string_column(self):
        ...
        # Verificar que una columna numérica lanza TypeError
    ...
    def test_remove_outliers_iqr_removes_extreme_values(self):
        ...
        """
        # Crear un DataFrame con más datos donde 120 sea un outlier claro
        df = pd.DataFrame({
            "name": ["Alice", "Bob", "Charlie", "David", "Eve", "Frank"],
            "age": [25, 28, 30, 32, 35, 120],  # 120 es un outlier claro
        ...
        # Verificar que el valor extremo (120) fue eliminado
        self.assertNotIn(120, result["age"].values)
        
        # Verificar que los valores no extremos permanecen
        self.assertIn(25, result["age"].values)
        self.assertIn(30, result["age"].values)
    ...
    def test_remove_outliers_iqr_raises_typeerror_for_non_numeric_column(self):
        ...
        # Verificar que una columna no numérica lanza TypeError
        with self.assertRaises(TypeError):
